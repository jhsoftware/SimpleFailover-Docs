...
![](images/4ae9ddf5a3cc.png)

- **Launch user interface to system tray at Windows login**\
With this option enabled, the Simple Failover user interface will automatically be started as an icon in the [system tray](gui_tray.md) whenever you log on to Windows.\
